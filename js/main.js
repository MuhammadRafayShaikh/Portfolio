...
// 				// Validation: Check if the name has at least 3 characters
// 				if (name.length < 3) {
// 					Swal.fire({
// 						icon: 'error',
...
// 				// Validation: Check if the message has at least 25 characters
// 				if (message.length < 25) {
// 					Swal.fire({
// 						icon: 'error',
// 						title: 'Message Too Short',
// 						text: 'Message must have at least 25 characters!',
// 					});
// 					return; // Stop form submission
// 				}
...
// 				const endpoint = "https://formsubmit.co/14a4f53e9e4d7cf17b09679e43390671"; // Replace with your Formspree endpoint
...
// 							icon: 'error',
// 							title: 'Oops...',
// 							text: 'Message sending failed. Please try again later.',
// 						});
// 					})
// 					.finally(function () {
...
function submitForm() {
   ...
   const endpoint = "https://formsubmit.co/14a4f53e9e4d7cf17b09679e43390671";
   ...
   axios.post(endpoint, formData)
	 ...
	 .catch(error => {
	   console.error(error);
	   showError('Message sending failed. Please try again later.');
	 });
 }
 ...
 function showSuccess(message) {
   Swal.fire({ icon: 'success', title: 'Success!', text: message, confirmButtonColor: '#28a745' });
 }
